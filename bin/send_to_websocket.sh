...
WS_SERVER="saiyo2019.moi.st"
WS_PORT=8888

# The header values to use when performing a websocket handshake.
HS_GET="/websocket/8127c3843fc7451ba268c41f158121ff"
HS_ORIGIN="https://saiyo2019.moi.st"
HS_HOST="saiyo2019.moi.st"
...
nc -l -p $WS_LOCAL_PORT | nc $WS_SERVER $WS_PORT > /dev/null &
nc1_pid=$!
nc2_pid=`jobs -p`
